...
namespace FairMark.OmsApi.DataContracts
{
    ...
    /// 4.5.1.1.13 Расширения для производителей пива, напитков, изготавливаемых на основе пива и слабоалкогольных напитков, Таблица 27.
    /// </summary>
    [DataContract]
    public partial class Order_Beer : Order<OrderProduct_Beer>
    {
